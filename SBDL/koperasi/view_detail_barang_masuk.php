    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="input_barang2.php">Input Barang</a></h3>
        ...
        <div class="box-body">
          ...
          ?>
          <h3 align="center">Detail Barang Masuk</h3>
          <div class="table-responsive">
          <table border="1" cellspacing="7" cellpadding="0" align="center" width="80%" heigh="30%">
              <tr>
                  <th>No.</th>
                  <th>Kode Masuk</th>
                  <th>Tanggal Masuk</th>
          ...
          <?php
              $no=1;
              $query=("SELECT * FROM struktur_barang_masuk");
          ...
          ?>
              <tr>
                  ...
                  <td><?php echo"$r[Kd_Masuk]";?></td>
                  <td><?php echo"$r[Tgl_Masuk]";?></td>
                  <td><?php echo"$r[Kd_Barang]";?></td>
                  <td><?php echo"$r[Hrg_Beli]";?></td>
                  <td><?php echo"$r[Jml_Masuk]";?></td>
                  <td align="center"><a href="detail_barang_masuk.php?Kd_Masuk=<?=$r['Kd_Masuk'];?>">Detail |</a>
                   <a href="delete_Kd_Masuk.php?Kd_Masuk=<?= $r['Kd_Masuk'];?>">Delete</a></td>
