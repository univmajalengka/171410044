    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
            ...
            ?>
            <h3 align="center">Data Pemesanan Barang</h3>
            <div class="table-responsive">
            <table border="1" cellspacing="7" cellpadding="0" align="center" width="80%" heigh="20%">
                <tr>
                    <th>No.</th>
                    <th>Kode Jual</th>
            ...
            <?php
                $no=1;
                $query=("SELECT * FROM struktur_transaksi_penjualan");
            ...
            ?>
                <tr>
                    ...
                    <td align="center"><a href="detail_transaksi_penjualan.php?Kd_jual=<?=$r['Kd_jual'];?>">Detail |</a>
