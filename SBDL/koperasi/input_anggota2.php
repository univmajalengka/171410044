    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <tr>
          <th></th>
        <tr>
          <th align="right">Kode Pelanggan :</th>
          <td><INPUT TYPE="text" NAME="kd_pel" SIZE="30"></td>
        </tr>
        <tr>
          <th align="right">Nama Anggota :</th>
          <td><INPUT TYPE="text" NAME="nama" SIZE="30"></td>
        </tr>
        <tr>
          <th align="right">Alamat Anggota :</th>
        ...
        <tr>
          <th align="right"></th>
          <td><button type="submit" name="submit" class="btn btn-default">SIMPAN</button></td>
        </tr>
        </table>
        </form>          
<!-- GANTI SAMPAI SINI -->
