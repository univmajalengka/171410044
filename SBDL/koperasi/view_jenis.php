    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="input_jenis2.php">Input Barang</a></h3>
        ...
        <div class="box-body">
            <?php
                ...
                ?>
                <h3 align="center">Data Jenis Barang</h3>
                ...
                <?php
                    $no=1;
                    $query=("SELECT * FROM struktur_kd_jenis");
                ...
                ?>
                    <tr>
                        ...
                        <td align="center"><a href="detail_jenis.php?kd_jenis=<?=$r['Kd_jenis'];?>">Detail |</a>
                            <a href="delete_Kd_jenis.php?Kd_jenis=<?= $r['Kd_jenis'];?>">Delete</a></td>
