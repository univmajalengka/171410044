    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="input_detail_barang2.php">Input Barang</a></h3>
...
?>
<h3 align="center">Data Detail Barang Jual</h3>
...
<?php
    $no=1;
    $query=("SELECT * FROM struktur_detail_transaksi");
...
?>
    <tr>
        ...
        <td align="center"><?php echo"$r[total_jual]";?></td>
        <td><a href="detail_detail_barang.php?kd_jual=<?=$r['kd_jual'];?>">Detail |</a>
        <a href="delete_kd_jual.php?kd_jual=<?= $r['kd_jual'];?>">Delete</a></td>
