      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="simpan_anggota.php"><i class="fa fa-circle-o"></i> Anggota</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="input_anggota.php">Input Anggota</a></h3>
...
<?php
    $no=1;
    $query=("SELECT * FROM struktur_anggota");
...
?>
    <tr>
        ...
        <td align="center"><a href="detail_anggota.php?Kd_Pelanggan=<?=$r['Kd_Pelanggan'];?>">Detail |</a>
            <a href="delete_Kd_Pelanggan.php?Kd_Pelanggan=<?= $r['Kd_Pelanggan'];?>">Delete</a></td>
